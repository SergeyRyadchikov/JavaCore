package gb.javacore.lesson4.Service;
/* 
@author Sergey Ryadchikov
 */

import gb.javacore.lesson4.Exceptions.AmountException;
import gb.javacore.lesson4.Exceptions.CustomerException;
import gb.javacore.lesson4.Exceptions.ProductException;
...
public class ShopService {
    ...
    private Order makePurcher(String phone, String title, int amount) throws CustomerException, ProductException, AmountException {
